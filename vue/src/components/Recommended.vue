...
<template>
  ...
  <section class="bg-gray-200">
    <div class="padded-container flex gap-x-8 flex-wrap justify-center pt-8 md:pt-0">
      <div
        class="flex flex-col justify-center md:items-end basis-full md:basis-[calc(50%-1rem)] text-left md:text-right">
        <h2 class="text-4xl font-light">e-Fiskalizacija</h2>
        <p class="my-8"> Duis aute irure dolor in reprehenderit in voluptate velit esse cillum
          dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia
          deserunt mollit anim id est laborum.</p>
        <button class="bg-blue-500 hover:bg-blue-700 text-white p-2 rounded w-[10rem]">Saznaj
          više</button>
      </div>
      <div class="flex justify-center basis-full md:basis-[calc(50%-1rem)] items-center">
        <img src="@/assets/images/dp-25.webp" alt="dp-25 fiskalna kasa" class="max-w-[300px]">
      </div>
    </div>
    <Carousel>
